...
public class TestAccessPropertyFile {
    ...
    @Test
    public String getBasePath(String environment) {
        TestBasePlatform uri = new TestBasePlatform();
        Properties properties = new Properties(); // Declare and initialize properties

        try {
            FileInputStream fis = new FileInputStream(String.valueOf(uri.getProperties(environment)));
            properties.load(fis);
...
/*    @Test
    public String getBasePath() {
        TestBasePlatform uri = new TestBasePlatform();
        try {
            FileInputStream fis = new FileInputStream(uri.getProperties());
            properties.load(fis);
            return properties.getProperty("baseURI");
        } catch (IOException e) {
            throw new RuntimeException(e);
